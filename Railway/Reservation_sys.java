/* This Class contains the MAIN method so execte the program for here    */
/*#######################################################################*/
/*#######################################################################*/
...
class Reservation_sys
{
	...
	void main_menu() throws Exception
	{
		...
		switch(ch)
		{
			...
			case 2: u_user_login();
				break;
			default:System.out.println("This is Railway Reservation System");
				   System.exit(0);
				break;
	...
	System.out.println("**************************************************************************************************************");
		System.out.println();
		System.out.println();	
		Reservation_sys rail=new Reservation_sys();
		rail.main_menu();
	}			
}


/* This project is devloped by NITISH KUMAR MISHRA */
/*#######################################################################*/
/*#######################################################################*/